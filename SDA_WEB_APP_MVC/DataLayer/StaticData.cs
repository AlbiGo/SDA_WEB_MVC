...
namespace SDA_WEB_APP_MVC.DataLayer
{
    public static class StaticData
    {
        public static List<Artikull> Artikujt = new List<Artikull>()
        {
            ...
            {
                ID = 1,
                PhotoUrl = "C:\\Users\\User\\source\\repos\\SDA_WEB_APP_MVC\\SDA_WEB_APP_MVC\\wwwroot\\Images\\photo-1523275335684-37898b6baf30.jfif",
                DateCreated = new DateTime(2026,8,14),
                Name = "Laptop PC",
